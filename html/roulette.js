...
function WheelSpin()
{
    ...
    let msg = JSON.stringify([number,color,parity,grade]);
    sock.send(msg);
}


function messageRecieved(ev){
    let msg = ev.data
    console.log(msg)
    ...
    let roul_node1 = document.createTextNode(data[0]);
    let roul_node2 = document.createTextNode(data[1]);
    let roul_node3 = document.createTextNode(data[2]);
    let roul_node4 = document.createTextNode(data[3]);
    let space0 = document.createTextNode(" ");
    let space1 = document.createTextNode(" ");
    let space2 = document.createTextNode(" ");
...
function main()
{
    ...
    sock.addEventListener("message", messageRecieved);
